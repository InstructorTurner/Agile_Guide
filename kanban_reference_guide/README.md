...
**Kanban is a flow-based system.** Unlike methods that rely on fixed timeboxes (like Scrum), Kanban focuses on maximizing the speed and smoothness of work (flow) by visualizing the process and strictly limiting the amount of active work.
...
1.  Start at the Overview (`00_kanban_overview.md`) to understand the philosophy.
