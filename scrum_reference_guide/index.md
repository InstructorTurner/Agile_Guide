...
*   **Quick Reference:** Use the document specific to the event (e.g., `04_daily_scrum.md`) when the event is happening.
*   **Learning:** Read the foundational documents (`00_scrum_overview.md` and `01_user_story_guide.md`) first.
*   **Core Principles:** Pay special attention to the sections on **limiting Work In Progress (WIP)** and building **Vertical Slices**.
